...
CLONE_HELP_2 = """
<b><u>⊚ ᴀᴅᴅɪᴛɪᴏɴᴀʟ ᴄᴏᴍᴍᴀɴᴅs </u></b>


<b>ᴜsᴇ /clone ᴄᴏᴍᴍᴀɴᴅ ᴛᴏ ᴄʟᴏɴᴇ ʏᴏᴜʀ ᴏᴡɴ ʙᴏᴛ ғʀᴏᴍ @TamannaCloneBot ᴜsɪɴɢ ᴀ ʙᴏᴛ ᴛᴏᴋᴇɴ ғʀᴏᴍ ʙᴏᴛғᴀᴛʜᴇʀ.</b>

<b><u>⊚ ғᴏʀ ᴀʟʟ ᴜsᴇʀs :</u>
<blockquote>
/mybot – Cʜᴇᴄᴋ ᴛʜᴇ ʙᴏᴛs ʏᴏᴜ’ᴠᴇ
/botinfo – ᴄʜᴇᴄᴋ ʏᴏᴜʀ ʙᴏᴛ’s ɪɴғᴏʀᴍᴀᴛɪᴏɴ (ᴏɴʟʏ ғᴏʀ ʙᴏᴛ ᴏᴡɴᴇʀs).
/logger - ғᴏʀ ᴇɴᴀʙʟᴇ|ᴅɪsᴀʙʟᴇ ʙᴏᴛ ʟᴏɢs.
/logstatus - ᴄʜᴇᴄᴋ ʟᴏɢɢᴇʀ ᴇɴᴀʙʟᴇ|ᴅɪsᴀʙʟᴇ.
/setlogger - sᴇᴛ ʟᴏɢɢᴇʀ ɢʀᴏᴜᴘ ᴡɪᴛʜ ɢʀᴏᴜᴘ ɪᴅ.</blockquote></b>

<b><u>⊚ ғᴏʀ ᴘʀᴇᴍɪᴜᴍ ғᴏʀ ᴀʟʟ ᴜsᴇʀs :</u>
<blockquote>
/setchannel – ᴀᴅᴅ ʏᴏᴜʀ ᴏᴡɴ ᴄʜᴀɴɴᴇʟ ᴛᴏ ʏᴏᴜʀ ʙᴏᴛ.
/setsupport – ᴀᴅᴅ ʏᴏᴜʀ sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ ᴛᴏ ʏᴏᴜʀ ʙᴏᴛ.
/broadcast – sᴇɴᴅ ᴀ ᴍᴇssᴀɢᴇ ᴛᴏ ᴀʟʟ ᴜsᴇʀs ᴏғ ʏᴏᴜʀ ʙᴏᴛ.
ᴇxᴀᴍᴩʟᴇ: <code>/broadcast -user ᴛᴇsᴛɪɴɢ ʙʀᴏᴀᴅᴄᴀsᴛ</code>
</blockquote></b>

<u><b>⊚ ᴍᴏʀᴇ ғᴇᴀᴛᴜʀᴇs ᴄᴏᴍɪɴɢ sᴏᴏɴ...</b></u>
"""
